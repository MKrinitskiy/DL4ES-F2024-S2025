...
| ----- | ---- | ----- | ------- |
|       |      | I семестр |    |
| Лекция 1 | 17.09.2023 | Основы нейросетевых моделей в машинном обучении: повторение. | [видеозапись](https://ml4es.ru/links/2024-09-17-DL4ES2024-Lect01)<br />[материалы занятия]() |
| Лекция 2 | 24.09.2024 | Градиентная оптимизация: метод градиентного спуска | [видеозапись](https://ml4es.ru/links/2024-09-24-DL4ES2024-Lect02)<br />[материалы занятия]() |
| Лекция 3 | 01.10.2024 | Градиентная оптимизация: метод стохастического градиентного спуска | [видеозапись](https://ml4es.ru/links/2024-10-01-DL4ES2024-Lect03)<br />[материалы занятия]() |
| Лекция 4 | 08.10.2024 | Автоматическое вычисление градиентов.<br />Метод обратного распространения ошибки. | [видеозапись](https://ml4es.ru/links/2024-10-08-DL4ES2024-Lect04)<br />[материалы занятия]() |
